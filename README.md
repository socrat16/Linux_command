...
`resolvectl dns` - Просмотр DNS-серверов  
...
```
```
~# lsof -iTCP | grep nginx j
nginx      923            root    6u  IPv4  22761      0t0  TCP *:https (LISTEN)
nginx      924        www-data    6u  IPv4  22761      0t0  TCP *:https (LISTEN)
nginx      925        www-data    6u  IPv4  22761      0t0  TCP *:https (LISTEN)
```
