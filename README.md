...
------------------------------------------------------------------------------------------------------------------------------------------------------
rsync  -avz  --delete /root/sisi/ /root/lol   удалит в приемнике файлы кот. не в источнке. передается то, что только из изменено
...
https://habr.com/ru/company/ruvds/blog/568614/
 ...
 wget -  работа с URL страницами. для конектов к серву по разным протоколам с синтткс  урл. wget -b -o ~/wget.log http://ftp.gnu.org/gnu/wget/wget-1.5.3.tar.gz  -
